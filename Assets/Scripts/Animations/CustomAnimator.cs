...
public class CustomAnimator
{
    ...
    public CustomAnimator(SpriteRenderer renderer, List<Sprite> animFrames, float frameRate = 0.20f)
    {
    ...
    //Controls the animation framerate and sprites of the characters

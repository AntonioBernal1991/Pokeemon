...
public class BattleHud : MonoBehaviour
{
    ...
    //Updates the LifeBar after a Pokemon was hit.
    ...
    //Sets the Experience bar of the pokemon
    public void SetExp()
    {
        if (expBar == null)
        {
    ...
    //Sets the life after a pokemon was hit in a smooth transisiton.
    ...
    //Normalize the Experience stat of a pokemon
    float NormalizedExp()
    {
    ...
    //Sets the level of each pokemon during battle
    public void SetLevelText()
    {
        pokemonLevel.text = $"Lv {_pokemon.Level}";
    }
    //Sets the statusof each pokemon during battle
